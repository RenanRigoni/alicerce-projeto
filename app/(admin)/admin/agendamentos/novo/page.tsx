      ...
      <Card>
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label className="block text-sm font-medium mb-1.5" style={labelStyle}>
              Paciente{' '}
              <span style={{ color: 'var(--color-ink-faint)', fontWeight: 400 }}>(opcional)</span>
            </label>
          ...
          <div>
            ...
            <input
              ...
              value={form.titulo}
              onChange={handle}
              placeholder="Ex: Sessão de TO, Devolutiva semestral..."
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handle}
              rows={2}
              placeholder="Informações úteis para a terapeuta sobre este agendamento"
          ...
          <label className="flex items-center gap-2.5 cursor-pointer">
            ...
            <span className="text-sm" style={{ color: 'var(--color-ink-mid)' }}>
              Visível para o responsável no portal
            </span>
          </label>
