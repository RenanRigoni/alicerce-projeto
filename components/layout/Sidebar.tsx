...
const navConfig: Record<string, NavItem[]> = {
  admin: [
    ...
    { href: '/admin/aniversarios',  label: 'Aniversários',  icon: Cake,         permission: 'ver_todos_pacientes' },
  ...
  terapeuta: [
    ...
    { href: '/terapia/aniversarios', label: 'Aniversários',  icon: Cake,            permission: null },
  ],
  pai: [
